// import { MessageType, Mimetype, proto } from 'baileys';
...
//     conn.sendMessage(jid, 'Wait a minute', 'extendedTextMessage');
//     try {
...
//       conn.sendMessage(jid, `Sorry, something went wrong and I can't convert your image to sticker`, 'extendedTextMessage', {
//         quoted: message,
//       });
//     }
//   };
